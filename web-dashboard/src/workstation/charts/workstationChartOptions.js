...
export const WS_CHART_COLORS = {
  background: '#fbfcfa',
  text: '#5f6b67',
  grid: 'rgba(38, 58, 51, 0.038)',
  gridMajor: 'rgba(38, 58, 51, 0.06)',
  border: '#e5eae8',
  up: '#17a36b',
  down: '#dc6464',
  upWick: '#17a36b',
  downWick: '#dc6464',
  crosshair: 'rgba(70, 88, 82, 0.26)',
...
export function createWorkstationChartOptions({ width, height, showTimeAxis = false, panelId = null, interactionEnabled = true, passiveCamera = false, hidePriceScale = false, reservePriceScaleGutter = false, compact = false } = {}) {
  ...
  return {
    ...
    crosshair: {
      ...
      vertLine: { color: WS_CHART_COLORS.crosshair, width: 1, style: 0, visible: true, labelVisible: showTimeAxis, labelBackgroundColor: '#68746f' },
      horzLine: { visible: !hidePriceScale && !gutterOnly, color: WS_CHART_COLORS.crosshair, width: 1, style: 2, labelVisible: !hidePriceScale && !gutterOnly, labelBackgroundColor: '#68746f' },
    },
