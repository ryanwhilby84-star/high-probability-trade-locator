    ...
    return linked.subscribeGeometry(() => {
      ...
      try {
        ...
        if (!hard.ok && import.meta.env?.DEV) {
          console.error('[GOLDVW] sharedVisibleRange invariant broken', hard)
        }
      } catch {
        /* ignore */
      }
      ...
      <header className="cot-ws-page-topbar">
        ...
        <div className="cot-ws-page-topbar-right">
          <span
            ...
            data-testid="goldvw-price-badge"
          >
          ...
          <button
            type="button"
            className="cot-ws-page-btn"
            data-testid="goldvw-return-live"
        ...
        {historyDoc ? (
          <div className="ngvw-workstation">
            ...
            <section
              ...
              data-testid="goldvw-live-card"
            >
              <div className="ngvw-live-card-head">
                <h2>CURRENT GOLD VALUATION</h2>
              ...
              <div className="ngvw-hero-metrics">
                <div>
                  ...
                  <strong data-testid="goldvw-market-price">${fmt(liveState.market_price)}</strong>
                </div>
                <div>
                  <span>Market-clearing fair value</span>
                  <strong data-testid="goldvw-fair-value">${fmt(liveState.physical_fair_value)}</strong>
                </div>
                <div>
                  <span>Valuation deviation</span>
                  <strong className="ngvw-hero-dev" data-testid="goldvw-live-deviation">
              ...
              <div className="ngvw-hero-state">
                <strong data-testid="goldvw-state-headline">{liveState.state_headline || '—'}</strong>
              ...
              <dl className="ngvw-live-meta">
                ...
                <div>
                  <dt>Price status</dt>
                  <dd data-testid="goldvw-price-status">{liveState.price_status}</dd>
                </div>
                <div>
                  <dt>Current comparison</dt>
                  <dd data-testid="goldvw-comparison-status">{liveState.comparison_status}</dd>
                </div>
                <div>
                  <dt>Model verdict</dt>
                  <dd data-testid="goldvw-model-verdict">{liveState.model_verdict || '—'}</dd>
                </div>
                <div>
                  <dt>Price updated</dt>
              ...
              {import.meta.env?.DEV ? (
                <pre className="ngvw-live-diag" data-testid="goldvw-live-diag">
                  {JSON.stringify(
                    {
